      ...
      <form action="shop.php" method="POST">
        <div class="row mx-auto container">
          <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="form-check">
              <input class="form-check-input" value="puma" type="radio" name="category" id="category_two" <?php if(isset($category) && $category== 'puma'){ echo 'checked' ;}?>>
            ...
            <div class="form-check">
              <input class="form-check-input" value="adidas" type="radio" name="category" id="category_two" <?php if(isset($category) && $category== 'adidas'){ echo 'checked' ;}?>>
              <label class="form-check-label" for="flexRadioDefault2">
                Adidas
              </label>
